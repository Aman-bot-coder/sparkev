...
public class AddVehicleLoginActivity extends AppCompatActivity implements VehicleBrandsAdapter.ClickButton, VehicleModelAdapter.ClickButton, VehicleYEarAdapter.ClickButton {
...
//        btn_login = (LinearLayout) findViewById(R.id.ly_login);
        ...
        tvBrand.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (Utils.isNetworkConnected(AddVehicleLoginActivity.this)) {
...
//
                ...
                if (response.code() == 200) {
                    try {
                        ...
                        callMailService(
                               ...
                               AddVehicleLoginActivity.class.getSimpleName(),
                                "SPIN_ANDROID",
                                AppUtils.project_id,
                                AppUtils.bodyToString(call.request().body()),
                                "ANDROID",
    ...
    private void addVehicle() {
        ...
        this.apiInterface.addVehicleDetails(hashMap1, new RequestAddVehicle(brandId, modelId, 15, regNo, yearOfMan, engineNo, chassisNo, "", "Y", Pref.getIntValue(Pref.TYPE.USER_ID.toString(), 0), 1, Pref.getIntValue(Pref.TYPE.USER_ID.toString(), 0))).enqueue(new Callback<ResponseAddVehicle>() {
                    ...
                    try {
                        ...
                        if (responseAddVehicle.status) {
                            ...
                            if ("LOGIN".equalsIgnoreCase(activity)) {
                                Intent intent = new Intent(AddVehicleLoginActivity.this, MainActivity.class);
//                            intent.putExtra("activity", "regi");
                                startActivity(intent);
                                AddVehicleLoginActivity.this.finish();
                            }
                            else {
                                Intent intent = new Intent(AddVehicleLoginActivity.this, MyVehicleActivity.class);
//                            intent.putExtra("activity", "regi");
                                startActivity(intent);
                                AddVehicleLoginActivity.this.finish();
                            }
...
//
                        ...
                        callMailService(
                               ...
                               AddVehicleLoginActivity.class.getSimpleName(),
                                ...
                                call.request().url().toString(),
                                "Y",
                                AppUtils.REQUEST_ERROR_CODE,
                                AppUtils.REQUEST_ERROR,
                                Pref.getIntValue(Pref.TYPE.USER_ID.toString(), 0),
                                Pref.getValue(Pref.TYPE.MOBILE.toString(), null));
                        Toast.makeText(getApplicationContext(), getResources().getString(R.string.server_not_found_please_try_again), Toast.LENGTH_LONG).show();
...
//            country.setSearch_data(responseCountry.search_data);
            vehicleBrandsAdapter = new VehicleBrandsAdapter(AddVehicleLoginActivity.this, brand_response,this);
...
//            country.setData(responseCountry.data);
          ...
          /*  listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            dialog_brand.dismiss();
            Toast.makeText(AddVehicleLoginActivity.this, "Vehicle brand not found", Toast.LENGTH_LONG).show();
        }
        dialog_brand.show();
...
//        dialog_Distance.setContentView(R.layout.dialog_distance);
        ...
        if (model_response.size() > 0) {
//            country.setSearch_data(responseCountry.search_data);
            vehicleModelAdapter = new VehicleModelAdapter(AddVehicleLoginActivity.this, model_response,this);
...
//            country.setData(responseCountry.data);
          ...
          /*  listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            dialog_model.dismiss();
            Toast.makeText(AddVehicleLoginActivity.this, "Vehicle model not found", Toast.LENGTH_LONG).show();
        }
        dialog_model.show();
...
//            country.setSearch_data(responseCountry.search_data);
            vehicleConnectorTypeAdapter = new VehicleConnectorTypeAdapter(AddVehicleLoginActivity.this, connectorType_response);
...
//            country.setData(responseCountry.data);
            ...
            dialog_connector.dismiss();
            Toast.makeText(AddVehicleLoginActivity.this, "Connector not found", Toast.LENGTH_LONG).show();
        }
...
//        dialog_Distance.setContentView(R.layout.dialog_distance);
        ...
        if (list_year.size() > 0) {
//            country.setSearch_data(responseCountry.search_data);
            vehicleYEarAdapter = new VehicleYEarAdapter(AddVehicleLoginActivity.this, list_year,this);
...
//            country.setData(responseCountry.data);
            ...
            dialog_year.dismiss();
            Toast.makeText(AddVehicleLoginActivity.this, "Country not found", Toast.LENGTH_LONG).show();
        }
        dialog_year.show();
    ...
    public void callMailService(int id, String username, String email, String device_id, String app_version, String os_version, String activity_name, String application_name, int project_id, String api_parameters, String application_plateform, String url, String status, int error_code, String error_discription, int created_by, String mobile) {
        ...
        Intent intent = new Intent(AddVehicleLoginActivity.this, MyService.class);
