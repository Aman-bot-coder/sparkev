...
public class HomeChargerListAdapter extends BaseAdapter {
    Context context;
    private List<Data> itemsModelListFiltered;
    ProgressDialog progress;
    ViewHolder viewHolder;

    public HomeChargerListAdapter(Context context, List<Data> itemsModelsl) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.home_charger_itemlist, parent, false);
...
//            viewHolder.expirydate.setText("" + itemsModelListFiltered.get(position).serialNo);
        } catch (Exception e) {
