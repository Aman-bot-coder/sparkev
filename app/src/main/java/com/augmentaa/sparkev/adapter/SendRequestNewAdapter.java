...
public class SendRequestNewAdapter extends BaseAdapter {
    Context context;
    private List<Data> itemsModelListFiltered;
    ProgressDialog progress;
    ViewHolder viewHolder;

    public SendRequestNewAdapter(Context context, List<Data> itemsModelsl) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.txtnickName.setText("you have requested to access the charger "+ itemsModelListFiltered.get(position).deviceNumber +" of " + itemsModelListFiltered.get(position).owner_name+".");
        ...
        if (itemsModelListFiltered.get(position).status == 1) {
            ...
            viewHolder.txt_permission.setTextColor(context.getResources().getColor(R.color.themeColor));
