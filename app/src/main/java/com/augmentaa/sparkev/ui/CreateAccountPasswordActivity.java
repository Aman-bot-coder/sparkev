...
public class CreateAccountPasswordActivity extends AppCompatActivity {
    ...
    Button btnContinue;
    String password, cnfPassword, name, mobile, email, fcm_id,username;
    int country_id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Logger.e(username);
            // this line has been added by pershant
...
//                        Toast.makeText(CreateAccountPasswordActivity.this, fcm_id, Toast.LENGTH_SHORT).show();
    ...
    private void postLoginData() {
        ...
        Logger.e("This console is by prashant "+country_id);
        this.apiSpinInterface.PostSignUp(new RequestSignUp(name, email,username, mobile, password, 3, country_id, project_id, fcm_id, version_name, os_version, device_unique_id,"SPARKEV")).enqueue(new Callback<ResponseRegistration>() {
...
//                Logger.e("Response SignUp: " + loginResponse.toString()+"  "+country_id);
                if (response.code() == 200) {
                    Logger.e("I am in the status code 200");
                    try {
                     ...
                     Pref.setIntValue(Pref.TYPE.USER_ID.toString(), loginResponse.username);
                            ...
                            Pref.setValue(Pref.TYPE.USERNAME.toString(),email);// this line has been added by me
                           //  Pref.setBoolValue(Pref.TYPE.LOGIN.toString(), true);// this line has been uncommneted by prashant
