...
import com.augmentaa.sparkev.ui.CreateAccountLocationPhoneActivity;
import com.augmentaa.sparkev.utils.Logger;

import java.util.ArrayList;
import java.util.List;

public class GetCountryListAdapter extends BaseAdapter implements Filterable {
    Context context;
...
//    ResponseCountry country=new ResponseCountry();
    ...
    public GetCountryListAdapter(Context context, List<Data> itemsModelsl) {
...
//        this.list_search=list_search;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        CreateAccountLocationPhoneActivity.country.setData(itemsModelListFiltered);
        Logger.e("======Data list=inner="+itemsModelListFiltered.size()+"   "+CreateAccountLocationPhoneActivity.country.getData());
